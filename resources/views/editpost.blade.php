              ...
              <hr class="border-gray-600">
                <div class="p-6 bg-gray-700">
                   <form class="w-full max-w-sm" method="POST">
                       @csrf
                        {{-- yaha pr http put support nhi krta, for manupulation --}}
                        @method('PUT')
                       ...
                       <div class="md:flex md:items-center">
                         ...
                         <div class="md:w-2/3">
                           <input type="submit" class="shadow bg-green-500 hover:bg-green-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" value="Update Post">
                         </div>
                       </div>
                     </form>
